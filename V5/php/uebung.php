...
<div class="rechts">
  ...
  <div class="formular"> <!-- "div" ist einfach nur ein Trenner für einen Abschnitt. Macht Sinn, eine gewisse Struktur reinzubringen. Mit der class="formular" kann im stylesheet genauer darauf zugegriffen werden -->
    <form method="post" action="aufnahme.php"> <!-- Das Formular. "POST" ist die sicherste Variante zum Abschicken. Das Formular wird wieder an die gleiche Datei geschickt. Verarbeitung siehe unten! -->

    <form action="aufnahme.php" method="post">
